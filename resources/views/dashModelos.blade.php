...
<div id="botaoCadUsuario">
    <a href="/cadastroModelo">Cadastro de modelos</a>
</div>
    ...
    <div class="padding">
        <div class="row container d-flex" style="background-color: rgb(177, 174, 174)">
            <div class="col-lx-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Modelos Cadastrados</h4>
                        <p class="card-description"> Todos os modelos cadastrados </p>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach ($modelos as $modelo)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editarModelo/<?= $modelo->id ?>" id="view" class="button" >
                                                <i class="fa fa-eye fa-align-center" aria-hidden="true" style="font-size: 20px"></i>
                                            </a>
                                            <a  class="button" id="view"  onclick="deletarTurno('<?= $modelo->id?>')">
...
<script>
    function deletarTurno(id) {
        let text = "Deseja realmente deletar o modelo?";
        if (confirm(text) == true) {
            const link = document.getElementsByName("link")[0].value;

            const url = link+"/api/deletarModelo";
            $.ajax({
                url: url,
                type: 'POST',
                headers: {
                ...
                error: function () {
                    alert("Houve um problema ao deletar o modelo!");
                },
            });
        }
    }
